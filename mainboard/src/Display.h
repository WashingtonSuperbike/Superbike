...
/// The Teensy pin used for the display's chip select pin. Needs to be updated for new board or new microcontroller
#define TFT_CS 10 
/// The Teensy pin used for the display data/command pin. Needs to be updated for new board or new microcontroller
#define TFT_DC 9 
/// The Teensy pin used for the display reset pin. Needs to be updated for new board or new microcontroller

#define TFT_RST 8 

/// The Teensy pin used for the display touch-screen chip select. Needs to be updated for new board or new microcontroller
/// This is useless because we dont use the touch screen. 
#define TS_CS  10 

// MOSI=11, MISO=12, SCK=13 | These may need to change for ESP32. SPI hardware pins
...
#define NUM_DATA 11 -> Can be moved to config.h file?  
...
// Gear ratio needs to change for new bike
